...
for dataset_size in 250 500 750 1000 1250 1500 1750 2000; do
    ...
    python3 -u scripts/measure_cem_time.py +cem=wd model=simple_net $ARGS
    python3 -u scripts/measure_cem_time.py +cem=logit model=simple_net $ARGS

    # label-free CEMs
    python3 -u scripts/measure_cem_time.py model=clmean $ARGS
    python3 -u scripts/measure_cem_time.py model=set2set $ARGS
    python3 -u scripts/measure_cem_time.py model=te $ARGS
